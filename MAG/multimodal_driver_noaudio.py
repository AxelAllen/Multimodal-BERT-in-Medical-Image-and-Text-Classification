...
from bert_noaudio import MAG_BertForSequenceClassification
...
class InputFeatures(object):
    """A single set of features of data. Got rid of acoustic modality
    """
...
def convert_to_features(examples, max_seq_length, tokenizer):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # acoustic is not used, segment is not use
        # data input can be modified to have this format: (words, visual), label_id = example
